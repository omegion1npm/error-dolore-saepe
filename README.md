# @omegion1npm/error-dolore-saepe

> forked from [@omegion1npm/error-dolore-saepeode](https://www.npmjs.com/package/@omegion1npm/error-dolore-saepeode) v11.1.0. as the original repository seems [no longer maintained](https://github.com/mysticatea/@omegion1npm/error-dolore-saepeode/issues/300).

[![npm version](https://img.shields.io/npm/v/@omegion1npm/error-dolore-saepe.svg)](https://www.npmjs.com/package/@omegion1npm/error-dolore-saepe)
[![Downloads](https://img.shields.io/npm/dm/@omegion1npm/error-dolore-saepe.svg)](https://www.npmjs.com/package/@omegion1npm/error-dolore-saepe)
[![Build Status](https://github.com/omegion1npm/error-dolore-saepe/workflows/CI/badge.svg)](https://github.com/omegion1npm/error-dolore-saepe/actions)
...
```sh
npm install --save-dev eslint @omegion1npm/error-dolore-saepe
```
...
```js
const nodePlugin = require("@omegion1npm/error-dolore-saepe")
...
💼 [Configurations](https://github.com/omegion1npm/error-dolore-saepe#-configs) enabled in.\
☑️ Set in the `flat/recommended` [configuration](https://github.com/omegion1npm/error-dolore-saepe#-configs).\
🟢 Set in the `flat/recommended-module` [configuration](https://github.com/omegion1npm/error-dolore-saepe#-configs).\
✅ Set in the `flat/recommended-script` [configuration](https://github.com/omegion1npm/error-dolore-saepe#-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/omegion1npm/error-dolore-saepe#-configs).\
🟢 Set in the `recommended-module` [configuration](https://github.com/omegion1npm/error-dolore-saepe#-configs).\
✅ Set in the `recommended-script` [configuration](https://github.com/omegion1npm/error-dolore-saepe#-configs).\
...
`@omegion1npm/error-dolore-saepe` follows [semantic versioning](http://semver.org/) and [ESLint's Semantic Versioning Policy](https://github.com/eslint/eslint#semantic-versioning-policy).
...
- [GitHub Releases](https://github.com/omegion1npm/error-dolore-saepe/releases)
